...
STICKERS = (
    "CAACAgUAAxkBAAECnmNg-maREvMYQkgaYJ6byMsSg5KhWgACPAMAAnrH0Vc6MLHVvinjfyAE",
    "CAACAgUAAxkBAAECnmFg-maOlY21DExmdraN_1pjzJ1k7wACnQUAAmqs2Fev854SknUWDCAE",
    "CAACAgUAAxkBAAECnl9g-maLnzthnrR3uRclb2u_jqbnNgACUwMAAhbf2Fc_1l3a5mWuZSAE",
    "CAACAgUAAxkBAAECnltg-maFyVlNaHq7fNdjJCWFe73GMAAC6QMAAhKI0VdRnrfYoeZigiAE",
    "CAACAgUAAxkBAAECnltg-maFyVlNaHq7fNdjJCWFe73GMAAC6QMAAhKI0VdRnrfYoeZigiAE",
    "CAACAgUAAxkBAAECnldg-mZ-KJTPqkzeR3_kpEi6Id-M4wACEAIAAhvV2VfEB1rpGkq_bCAE",
)
...
async def get_start_func(message, strings, edit=False):
    ...
    buttons.add(
        ...
        InlineKeyboardButton(
            strings["btn_group"], url="https://t.me/countdraculasupport"
        ),
    )
    buttons.add(
        InlineKeyboardButton(
            "☠️ Add Count Dracula to your group",
            url=f"https://telegram.me/CountDracula_bot?startgroup=true",
        )
    )
...
async def help_cmd_g(message, strings):
    ...
    button = InlineKeyboardMarkup().add(
        InlineKeyboardButton(text=text, url="https://t.me/CountDracula_bot?start")
    )
    await message.reply(strings["help_header"], reply_markup=button)
